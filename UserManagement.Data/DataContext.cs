...
{
    private readonly UserLogInterceptor _userLogInterceptor = new();
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder options)
    {
        ...
        options.AddInterceptors(_userLogInterceptor);
    }

    protected override void OnModelCreating(ModelBuilder model)
    {
        model.Entity<User>()
            .HasData(UserSeedData());
    ...
    private static User[] UserSeedData() => new[]
    {
        new User
        {
            Id          = 1,
